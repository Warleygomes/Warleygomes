...
e pós-graduado em **Engenharia de Dados** pela [PUC-Minas](https://www.pucminas.br/destaques/Paginas/default.aspx).  

Atualmente, atuo como **Engenheiro de Dados na Hapvida**, desenvolvendo soluções de cloud com **Python** e **PL/SQL**, integrando bancos de dados relacionais ou não relacionais (**Oracle** e **MONGODB**), criando **APIs** e implementando **ETL** com foco em **Engenharia Reversa** e **Enriquecimentos de dados internos e externos**.  
